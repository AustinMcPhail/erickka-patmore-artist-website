  ...
  return (
    <Post>
      <div className='journal-nav'>
        {prev && <Link className='prev btn' to={'/journal/' + prev.slug.current}><svg className='left' fill='none' stroke='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M7 16l-4-4m0 0l4-4m-4 4h18' /></svg>{prev.title}</Link>}
        {next && <Link className='next btn' to={'/journal/' + next.slug.current}>{next.title}<svg className='right' fill='none' stroke='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M17 8l4 4m0 0l-4 4m4-4H3' /></svg></Link>}
      </div>
